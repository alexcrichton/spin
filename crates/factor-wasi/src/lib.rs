...
impl Factor for WasiFactor {
        ...
        C: InitContext<Self>,
    {
        ...
        bindings::clocks::wall_clock::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::clocks::monotonic_clock::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::filesystem::types::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::filesystem::preopens::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::io::error::add_to_linker::<_, HasIo>(linker, get_io)?;
        bindings::io::poll::add_to_linker::<_, HasIo>(linker, get_io)?;
        bindings::io::streams::add_to_linker::<_, HasIo>(linker, get_io)?;
        bindings::random::random::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::random::insecure::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::random::insecure_seed::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::cli::exit::add_to_linker::<_, HasWasi>(linker, &Default::default(), get_wasi)?;
        bindings::cli::environment::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::cli::stdin::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::cli::stdout::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::cli::stderr::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::cli::terminal_input::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::cli::terminal_output::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::cli::terminal_stdin::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::cli::terminal_stdout::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::cli::terminal_stderr::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::sockets::tcp::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::sockets::tcp_create_socket::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::sockets::udp::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::sockets::udp_create_socket::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::sockets::instance_network::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
        bindings::sockets::network::add_to_linker::<_, HasWasi>(
            linker,
            &Default::default(),
            get_wasi,
        )?;
        bindings::sockets::ip_name_lookup::add_to_linker::<_, HasWasi>(linker, get_wasi)?;
...
impl wasmtime::component::HasData for HasWasi {
